...
#ifndef TEST_HARNESS_INTERFACE_MENABREA_TEST_PARAMS_PARSER_HH
#define TEST_HARNESS_INTERFACE_MENABREA_TEST_PARAMS_PARSER_HH
...
#endif /* TEST_HARNESS_INTERFACE_MENABREA_TEST_PARAMS_PARSER_HH */
